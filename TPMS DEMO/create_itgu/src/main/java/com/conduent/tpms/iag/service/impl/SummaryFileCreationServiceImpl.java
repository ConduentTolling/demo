...
@Service
public class SummaryFileCreationServiceImpl implements SummaryFileCreationService{
	...
	public void buildSummaryFile(Map<String,String> recordCountMap, String inputFileType, String destPath,String filename) {
		...
		try (FileWriter filewriterSummaryNew = new FileWriter(file, true)) {
			  ...
			  content.append("Statistics of ITGU file "+filename+" created on : "+timeZoneConv.currentTime().format(DateTimeFormatter.ofPattern("dd/MM/yyyy"))+" "+timeZoneConv.currentTime().format(DateTimeFormatter.ofPattern("hh:mm:ss")));
			  ...
			  filewriterSummaryNew.write("\r\n");
			  filewriterSummaryNew.write("Tags were in LOW balance status           : "+LOW_BAL);
			  filewriterSummaryNew.write("\r\n");
			  filewriterSummaryNew.write("Tags were in ZERO/NEGATIVE balance status : "+INVALID);
			  filewriterSummaryNew.write("\r\n");
			  filewriterSummaryNew.write("Tags were in INVALID tag status           : "+LOST);
			  filewriterSummaryNew.write("\r\n");

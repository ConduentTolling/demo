...
/**
 * POJO class for ITGU file header structure
 */
...
public class FileHeaderDto {
	...
	public String getPreviousFileDateTime() {
		return previousFileDateTime;
	}

	public void setPreviousFileDateTime(String previousFileDateTime) {
		this.previousFileDateTime = previousFileDateTime;
	}
	...
	public String toString() {
		return "FileHeaderDto [fileType=" + fileType + ", fromAgencyId=" + fromAgencyId + ", fileDate=" + fileDate
				...
				+ ", delimiter=" + delimiter + ", fileDateTime=" + fileDateTime + ", previousFileDateTime="
				+ previousFileDateTime + ", version=" + version + "]";
	}

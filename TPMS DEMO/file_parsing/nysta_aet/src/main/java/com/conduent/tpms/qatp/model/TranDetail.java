...
//	}
	...
	public String toString() {
		return "TranDetail [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", matchedTxExternRefNo="
				...
				+ ", itolFareAmount=" + itolFareAmount + ", frontOcrPlateCountry=" + frontOcrPlateCountry
				...
				+ ", rearImageColor=" + rearImageColor + ", etcFareAmount=" + etcFareAmount + ", cashFareAmount="
				+ cashFareAmount + ", expectedRevenueAmount=" + expectedRevenueAmount + ", postedFareAmount="
				+ postedFareAmount + ", atpFileIdList=" + atpFileIdList + "]";
	}

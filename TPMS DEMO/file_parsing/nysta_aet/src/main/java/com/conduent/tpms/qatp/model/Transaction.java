...
public class Transaction 
{
	...
	public TranDetail getTranDetail(TimeZoneConv timeZoneConv,MasterDataCache masterDataCacheInfo)
	{
		...
		if(entryTimeStamp!=null && !validate(entryTimeStamp))
		{
		...
		if(entryVehicleSpeed == null || validate(entryVehicleSpeed.toString()))
		{
			vehicleSpeed = 0;
		}
		...
		obj.setIsViolation(etcViolObserved);
		...
		if(matchedTxExternRefNo!=null)
		{
			obj.setMatchedTxExternRefNo(StringUtils.leftPad(String.valueOf(matchedTxExternRefNo), 16, "0"));
		}
		else
		{
			obj.setMatchedTxExternRefNo("0000000000000000");
		}
	...
	public String toString() {
		return "Transaction [masterDataCacheInfo=" + masterDataCacheInfo + ", laneTxId=" + laneTxId + ", txExternRefNo="
				...
				+ ", etcViolObserved=" + etcViolObserved + ", etcClassMismatch=" + etcClassMismatch + "]";
	}

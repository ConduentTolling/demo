...
import com.conduent.tpms.qatp.dao.InsertPbaDao;
import com.conduent.tpms.qatp.model.QatpStatistics;
import com.conduent.tpms.qatp.model.XferControl;

@Repository
public class InsertPbaDaoImpl implements InsertPbaDao {

	private static final Logger logger = LoggerFactory.getLogger(InsertPbaDaoImpl.class);

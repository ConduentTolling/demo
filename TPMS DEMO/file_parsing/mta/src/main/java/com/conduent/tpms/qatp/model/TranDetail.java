...
//	}
	...
	public void setTxExternRefNo(String txExternRefNo2) {
		this.txExternRefNo = txExternRefNo2;
	}
...
//	}
	...
	public String toString() {
		return "TranDetail [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txType=" + txType
				...
				+ ", cashFareAmount=" + cashFareAmount + ", itolFareAmount=" + itolFareAmount + ", aetFlag=" + aetFlag
				+ ", fileSeqNum=" + fileSeqNum + ", agTrxType=" + agTrxType + ", transType=" + transType
				...
				+ ", ti5PaymentFlag=" + ti5PaymentFlag + ", ti6RevenueFlag=" + ti6RevenueFlag + ", atpFileIdList="
				+ atpFileIdList + "]";
	}

 ...
 *
 */
public class QATPConstants {

//	public static final String NYSTA_AGENCY_ID = "007";
	public static final String MTA_AGENCY_ID = "002";
	public static final String MTA_DEVICE_PREFIX = "0008";
	public static final String MTA_FROM_AGENCY = "CSC";
	public static final String HOME_AGENCY_ID = MTA_AGENCY_ID;// Should be define in the DB. As tenant level
																// configuration.
	public static final String TRX_FILE_EXTENSION = ".TRX";
	public static final String UNDER_SCORE_CHAR = "_";
	public static final String FILE_TYPE = "FILE_TYPE";

	public static final String T_AGENCY_ID = "T_AGENCY_ID";
	...
	public static final Object PROCESS_STATUS_COMPLETE = "C";
	public static final Object PROCESS_STATUS_PROGRESS = "p";
	public static final Long ZERO = 0L;
	public static final String F_FROM_AGENCY_ID = "F_FROM_AGENCY_ID";
	public static final String F_FROM_ENTITY = "F_FROM_ENTITY";
	public static final String F_TO_ENTITY = "F_TO_ENTITY";
	...
	public static final String D_TAG_SERIAL_NUMBER = "D_TAG_SERIAL_NUMBER";
	...
	public static final String F_FILE_TYPE = "F_FILE_TYPE";
	public static final String LAST_LANE_TX_ID = "LAST_LANE_TX_ID";

	public static final String FILE_STATUS_IND = "FILE_STATUS_IND";
	public static final String LAST_TX_TIMESTAMP = "LAST_TX_TIMESTAMP";
	public static final String LAST_EXTERN_LANE_ID = "LAST_EXTERN_LANE_ID";
	public static final String LAST_EXTERN_PLAZA_ID = "LAST_EXTERN_PLAZA_ID";
	public static final String RECORD_COUNT = "RECORD_COUNT";
	public static final String RECONCILIATION_ID = "RECONCILIATION_ID";
	public static final String F_FILE_FL = "F_FILE_FL";
	public static final Integer SPEED_NOT_OVER_THRESHOLD=0;
	public static final Integer SPEED_OVER_THRESHOLD=1;
	public static final Integer AUTO_SUSPEND=2;
	public static final Integer TOLL_REVENUE_ETC=1;
	public static final Integer TOLL_REVENUE_VIDEO=50;
	public static final Integer TOLL_REVENUE_TOLL_EVADER=19; //Previous was 9
	public static final Integer TOLL_REVENUE_60=60;
	...
	public static final String TXN_FILE_NUM = "TXN_FILE_NUM";

...
public class TQatpMappingDaoImpl implements TQatpMappingDao 
{
	...
	public Long insertReconciliationCheckPoint(ReconciliationCheckPoint reconciliationCheckPoint)
	{
		...
		paramSource.addValue(QATPConstants.TXN_FILE_NUM,reconciliationCheckPoint.getFileSeqNum());
	...
	public FileParserParameters getMappingConfigurationDetails(FileParserParameters fielDto) {
		...
		paramSource.addValue(Constants.FILE_FORMAT, Constants.CSV);
	...
	private void getMinMaxListValues(List<MappingInfoDto> fileNameMappingDetails) {
		...
		{
			if (Constants.FIXED_VALUE.equals(infoRow.getValidationType()) || Constants.DATE.equals(infoRow.getValidationType())) 
			{
	...
	public boolean checkForDuplicateFileNum(String value) 
	{
		...
		paramSource.addValue(QATPConstants.TXN_FILE_NUM, value);

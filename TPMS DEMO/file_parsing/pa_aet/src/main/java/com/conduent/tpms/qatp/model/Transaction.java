...
{	
	...
	public TranDetail getTranDetail(TimeZoneConv timeZoneConv, MasterDataCache masterDataCacheInfo, Boolean dup) 
	{
		...
		obj.setRevenueDate(DateUtils.parseLocalDate(revenueDate, "yyyyMMdd"));
		
		//deviceNumber.equals("***********") || deviceNumber.equals("00000000000") || deviceNumber.equals("           ")
		...
		if (txTimeStamp != null) {
			...
			if(DateUtils.parseLocalDate(txTimeStamp.substring(0, 8),"yyyyMMdd") != null) 
			{
				try {
					...
					{
						Tplaza plazaInfo = masterDataCacheInfo.getPlazabyorder(3);
		...
		obj.setItolFareAmount(itolFareAmount!=null?itolFareAmount/100:0);
	...
	public String toString() {
		return "Transaction [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", trxType=" + trxType
				...
				+ ", agTrxType=" + agTrxType + ", etcViolObserved=" + etcViolObserved + ", revenueDate=" + revenueDate
				+ ", itolFareAmount=" + itolFareAmount + "]";
	}

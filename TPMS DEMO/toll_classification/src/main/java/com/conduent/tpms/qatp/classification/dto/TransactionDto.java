...
public class TransactionDto {
	...
	public String getAwayAgency() {
		return awayAgency;
	}

	public void setAwayAgency(String awayAgency) {
		this.awayAgency = awayAgency;
	}
	...
	public String toString() {
		return "TransactionDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txType=" + txType
				...
				+ ", matchedTxExternRefNo=" + matchedTxExternRefNo + ", txCompleteRefNo=" + txCompleteRefNo
				+ ", matchedTxStatus=" + matchedTxStatus + ", externFileDate=" + externFileDate + ", laneTxStatus="
				+ laneTxStatus + ", laneTxType=" + laneTxType + ", collectorClass=" + collectorClass
				+ ", collectorAxles=" + collectorAxles + ", preClass=" + preClass + ", preClassAxles=" + preClassAxles
				+ ", postClass=" + postClass + ", postClassAxles=" + postClassAxles + ", forwordAxles=" + forwordAxles
				+ ", reverseAxles=" + reverseAxles + ", deviceAxles=" + deviceAxles + ", readAVIClass=" + readAVIClass
				...
				+ revenueDate + ", isReciprocityTrx=" + isReciprocityTrx + ", cscLookupKey=" + cscLookupKey
				+ ", agTrxType=" + agTrxType + ", etcViolObserved=" + etcViolObserved + ", atpFileIdList="
				+ atpFileIdList + ", etcClassMismatch=" + etcClassMismatch + ", awayAgency=" + awayAgency
				+ ", direction=" + direction + ", event=" + event + ", hovFlag=" + hovFlag + ", hovPresenceTime="
				+ hovPresenceTime + ", hovLostPresenceTime=" + hovLostPresenceTime + ", avcDiscrepancyFlag="
				+ avcDiscrepancyFlag + ", degraded=" + degraded + ", uoCode=" + uoCode + ", avcProfile=" + avcProfile
				+ ", ti1TagReadStatus=" + ti1TagReadStatus + ", ti2AdditionalTags=" + ti2AdditionalTags
				+ ", ti3ClassMismatchFlag=" + ti3ClassMismatchFlag + ", ti4TagStatus=" + ti4TagStatus
				+ ", ti5PaymentFlag=" + ti5PaymentFlag + ", ti6RevenueFlag=" + ti6RevenueFlag + ", isSpeedViolation="
				+ isSpeedViolation + "]";
	}

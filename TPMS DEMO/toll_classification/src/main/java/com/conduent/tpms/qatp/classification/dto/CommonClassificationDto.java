...
//	}
	...
	public String toString() {
		return "CommonClassificationDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txSeqNumber="
				...
				+ ", discountedAmount2=" + discountedAmount2 + ", itolFareAmount=" + itolFareAmount
				+ ", etcViolObserved=" + etcViolObserved + ", direction=" + direction + ", event=" + event
				+ ", hovFlag=" + hovFlag + ", hovPresenceTime=" + hovPresenceTime + ", hovLostPresenceTime="

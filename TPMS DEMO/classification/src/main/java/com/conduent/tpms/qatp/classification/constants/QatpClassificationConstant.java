...
public class QatpClassificationConstant {
	...
	public static final String TX_STATUS_NOCC = "NOCC";
	public static final String NOCC = "200";
	public static final Object PARKING_THRESHOLD = "PARKING_THRESHOLD";
	public static final Integer MASTERCARD = 2;
	public static final Integer VISA = 4;

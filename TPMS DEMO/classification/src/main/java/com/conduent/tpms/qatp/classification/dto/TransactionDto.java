...
public class TransactionDto {
	...
	private Integer etcCorrReason;
	
	
	
	
	public Integer getEtcCorrReason() {
		return etcCorrReason;
	}

	public void setEtcCorrReason(Integer etcCorrReason) {
	...
	/*
	 * public String getEntryTxTimeStamp() { return entryTxTimeStamp; }
	 * 
	 * public void setEntryTxTimeStamp(String entryTxTimeStamp) {
	 ...
	 * 
	 * public void setTxTimeStamp(String txTimeStamp) { this.txTimeStamp =
	 * txTimeStamp; }
	 */
	...
	public static TransactionDto dtoFromJson(String message) {
		TransactionDto queueMessageDTO = null;
		//Gson gson = new Gson();
		/*
		 ...
		 * ZonedDateTimeConverter(DateTimeFormatter.ISO_ZONED_DATE_TIME)).create();
		 */
		...
		queueMessageDTO = gson.fromJson(message, TransactionDto.class);
	...
	public String toString() {
		return "TransactionDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txType=" + txType
				...
				+ tollRevenueType + ", entryTxTimeStamp=" + entryTxTimeStamp + ", eventTimestamp=" + eventTimestamp
				+ ", entryPlazaId=" + entryPlazaId + ", entryLaneId=" + entryLaneId + ", entryTxSeqNumber="
				+ entryTxSeqNumber + ", entryDataSource=" + entryDataSource + ", vehicleSpeed=" + vehicleSpeed
				...
				+ ", txStatus=" + txStatus + ", aetFlag=" + aetFlag + ", facAgency=" + facAgency + ", etcCorrReason="
				+ etcCorrReason + ", reserved=" + reserved + ", avcClass=" + avcClass + ", tagClass=" + tagClass
				+ ", transactionInfo=" + transactionInfo + ", laneDataSource=" + laneDataSource + ", laneHealth="
				+ laneHealth + ", avcAxles=" + avcAxles + ", tourSegment=" + tourSegment + ", bufRead=" + bufRead
				+ ", readerId=" + readerId + ", discountedAmount2=" + discountedAmount2 + ", discountedAmount="
				+ discountedAmount + ", tagIagClass=" + tagIagClass + ", planCharged=" + planCharged
				+ ", entryVehicleSpeed=" + entryVehicleSpeed + ", tourSegmentId=" + tourSegmentId + ", debitCredit="
				+ debitCredit + ", etcValidStatus=" + etcValidStatus + ", atpFileId=" + atpFileId + ", planType="
				+ planType + ", etcFareAmount=" + etcFareAmount + ", postedFareAmount=" + postedFareAmount
				+ ", expectedRevenueAmount=" + expectedRevenueAmount + ", videoFareAmount=" + videoFareAmount
				+ ", cashFareAmount=" + cashFareAmount + ", matchedTxExternRefNo=" + matchedTxExternRefNo
				+ ", txCompleteRefNo=" + txCompleteRefNo + ", matchedTxStatus=" + matchedTxStatus + ", externFileDate="
				+ externFileDate + ", laneTxStatus=" + laneTxStatus + ", laneTxType=" + laneTxType + ", collectorClass="
				+ collectorClass + ", collectorAxles=" + collectorAxles + ", preClass=" + preClass + ", preClassAxles="
				+ preClassAxles + ", postClass=" + postClass + ", postClassAxles=" + postClassAxles + ", forwordAxles="
				+ forwordAxles + ", reverseAxles=" + reverseAxles + ", deviceAxles=" + deviceAxles + ", readAVIClass="
				+ readAVIClass + ", readAVIAxles=" + readAVIAxles + ", deviceProgramStatus=" + deviceProgramStatus
				+ ", collectedAmount=" + collectedAmount + ", laneDeviceStatus=" + laneDeviceStatus
				+ ", postDeviceStatus=" + postDeviceStatus + ", preTrxbalance=" + preTrxbalance + ", revenueDate="
				+ revenueDate + ", event=" + event + ", hovFlag=" + hovFlag + ", isReciprocityTrx=" + isReciprocityTrx
				+ ", cscLookupKey=" + cscLookupKey + ", agTrxType=" + agTrxType + ", etcViolObserved=" + etcViolObserved
				+ ", isSpeedViolation=" + isSpeedViolation + "]";
	}

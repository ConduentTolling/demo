...
public class XferControl 
{
	...
	public String toString() {
		return "XferControl [xferControlId=" + xferControlId + ", xferFileId=" + xferFileId + ", xferFileName="
				+ xferFileName + ", dateCreated=" + dateCreated + ", timeCreated=" + timeCreated + ", fileSize="
				+ fileSize + ", fileCheckSum=" + fileCheckSum + ", numRecs=" + numRecs + ", hashTotal=" + hashTotal
				+ ", xferPath=" + xferPath + ", xferXmitStatus=" + xferXmitStatus + ", xferRetry=" + xferRetry
				+ ", updateTs=" + updateTs + ", fileType=" + fileType + "]";
	}

...
public class ViolTxDto {
	...
	public String toString() {
		return "ViolTxDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", postedFareAmount="
				...
				+ ", plateNumber=" + plateNumber + ", txTypeInd=" + txTypeInd + ", planTypeId=" + planTypeId
				+ ", txStatus=" + txStatus + ", plazaAgencyId=" + plazaAgencyId + ", externFileId=" + externFileId

...
public class ReconciliationDto {
	...
	public String toString() {
		return "ReconciliationDto [laneTxId=" + laneTxId + ", accountAgencyId=" + accountAgencyId + ", atpFileId="
				...
				+ collectorId + ", cscViolStatus=" + cscViolStatus + ", debitCreditFlag=" + debitCreditFlag
				+ ", feeCollected=" + feeCollected + ", feeNoticeAmount=" + feeNoticeAmount + ", fullFareAmount="
				+ fullFareAmount + ", imageUsed=" + imageUsed + ", laneMode=" + laneMode + ", nonRevenue=" + nonRevenue
				...
				+ tagStatus + ", tollAmount=" + tollAmount + ", tollCollected=" + tollCollected + ", trxSerialNumber="
				+ trxSerialNumber + ", txStatus=" + txStatus + ", txTimeStamp=" + txTimeStamp + ", vehicleSpeed="
				...
				+ ", deviceNo=" + deviceNo + ", externPlazaId=" + externPlazaId + ", externLaneId=" + externLaneId
				+ "]";
	}

...
public class EntryTxDto {
	...
	public String toString() {
		return "EntryTxDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", postedFareAmount="
				...
				+ ", planTypeId=" + planTypeId + ", txSubtypeInd=" + txSubtypeInd + ", tollSystemType=" + tollSystemType
				+ ", plazaAgencyId=" + plazaAgencyId + ", externFileId=" + externFileId + ", collectorId=" + collectorId

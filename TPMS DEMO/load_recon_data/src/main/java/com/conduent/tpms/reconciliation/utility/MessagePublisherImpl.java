...
public class MessagePublisherImpl implements MessagePublisher {
	...
	public boolean publishMessage(String laneTxId, byte[] msg, String streamId) {
		try {
			...
			logger.info("Put message - Published {} in {} ms", messages.size(), ChronoUnit.MILLIS.between(from, to));
			...
			logger.error("Fail to publish msg with laneTxId {}, {} Error: {}", laneTxId, msg,
	...
	public long publishMessages(List<PutMessagesDetailsEntry> messages) {
		...
		try {
			...
			logger.error("Fail to publish: Error: {}", ExceptionUtils.getStackTrace(e));
			return msgCounter;
		}
		return msgCounter;

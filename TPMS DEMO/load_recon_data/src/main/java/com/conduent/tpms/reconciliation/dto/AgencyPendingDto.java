...
public class AgencyPendingDto {
	...
	public String toString() {
		return "AgencyPendingDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", postedFareAmount="
				...
				+ ", plateNumber=" + plateNumber + ", txType=" + txType + ", txStatus=" + txStatus + ", planTypeId="
				+ planTypeId + ", plazaAgencyId=" + plazaAgencyId + ", externFileId=" + externFileId + ", collectorId="
				+ collectorId + ", laneMode=" + laneMode + ", deviceNo=" + deviceNo + ", plazaId=" + plazaId
				+ ", laneId=" + laneId + ", txTimeStamp=" + txTimeStamp + "]";
	}

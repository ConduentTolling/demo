...
public class TranDetailDto {
	...
	public String getTrxLaneSerial() {
		return trxLaneSerial;
	}
	public void setTrxLaneSerial(String trxLaneSerial) {
	...
	public String toString() {
		return "TranDetailDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", postedFareAmount="
				...
				+ ", planTypeId=" + planTypeId + ", debitCredit=" + debitCredit + ", trxLaneSerial=" + trxLaneSerial
				+ ", plazaAgencyId=" + plazaAgencyId + ", extFileId=" + extFileId + ", collectorId=" + collectorId
				+ ", laneMode=" + laneMode + ", deviceNo=" + deviceNo + ", plazaId=" + plazaId + ", laneId=" + laneId

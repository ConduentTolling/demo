package com.conduent.tpms.icrx.constants;
...
public class Constants {
	...
	public static final String GET_FILE_COUNT_FROM_TRAN_DETAIL = "GET_FILE_COUNT_FROM_TRAN_DETAIL";
	public static final String GET_FILE_COUNT_FROM_ACCT_TOLL = "GET_FILE_COUNT_FROM_ACCT_TOLL";
	public static final String GET_FILE_COUNT_FROM_ICRX_RECON = "GET_FILE_COUNT_FROM_ICRX_RECON";
	public static final String GET_OUTPUT_FILE_CONFIGURATION_INFO = "GET_OUTPUT_FILE_CONFIGURATION_INFO";
	public static final String GET_TX_DETAILS = "GET_TX_DETAILS";
	public static final String GET_TX_STATUS_VALUE = "GET_TX_STATUS_VALUE";
	public static final String GET_PLAN_VALUE = "GET_PLAN_VALUE";
	public static final String UPDATE_T_IA_FILE_STATS = "UPDATE_T_IA_FILE_STATS";
	public static final String GET_DUP_EXTERN_REF_NO = "GET_DUP_EXTERN_REF_NO";
	...
	public static final String  FILE_EXTENSION_ICTX = "ICTX"; //".ICTX";
	...
	public static final String TRANSACTION_ROW_ID = "TRANSACTION_ROW_ID";
	public static final String GET_XFER_CONTROL_IDS = "GET_XFER_CONTROL_IDS";
	...
	public static final int HOME_AGENCY_ID = 8;
	...
	public static final String D_ETC_DUP_SERIAL_NUM = "D_ETC_DUP_SERIAL_NUM";
	...
	public static final String ICRX_FILE_NAME = "ICRX_FILE_NAME";
	public static final String PROCESSED_FLAG = "PROCESSED_FLAG";
	public static final String DEPOSIT_ID = "DEPOSIT_ID";
	public static final String CREATE_ICRX = "CREATE_ICRX";
	public static final String CREATE_IRXC = "CREATE_IRXC";
	public static final String TEMP = "TEMP";
	public static final String IRXC = "IRXC";
	
	// POST STATUS
	public static final String RJDP = "RJDP";

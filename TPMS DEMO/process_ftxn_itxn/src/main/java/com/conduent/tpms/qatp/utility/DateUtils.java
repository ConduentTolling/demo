...
public class DateUtils
{
	...
	public static LocalDate parseLocalDateRecieved(final String value, final String pattern) 
	{
		...
		if (!Convertor.isEmpty(value)) 
		{
			...
			{
				logger.info("Invalid value of date");
				return null;
			}
		}
		return null;
	...
	public static LocalDate parseLocalDate(final String value, final String pattern) 
	{
		...
		if (!Convertor.isEmpty(value)) 
		{
			...
			{
				logger.info("Invalid value of date");
				return LocalDate.parse(CorrConstants.DEFAULT_DATE,dateFormatter);
			}
		}
		return null;
	}

...
public class FOTrnxDetailInfoVo implements Serializable {
	...
	public String toString() {
		return "FOTrnxDetailInfoVo [etcTrxSerialNum=" + etcTrxSerialNum + ", EtcRevenuDate=" + EtcRevenuDate
				+ ", etcFacAgency=" + etcFacAgency + ", etcTrxType=" + etcTrxType + ", etcEntryDate=" + etcEntryDate
				+ ", etcEntryTime=" + etcEntryTime + ", etcEntryPlaza=" + etcEntryPlaza + ", etcEntryLane="
				+ etcEntryLane + ", etcTagAgency=" + etcTagAgency + ", etcTagSerialNumber=" + etcTagSerialNumber
				...
				+ etcDebitCredit + ", etcTollAmount=" + etcTollAmount + "]";
	}

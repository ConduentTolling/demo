package com.conduent.tpms.recon.constants;
...
public class Constants {
	...
	public static final Object FULL = "FULL";
	...
	public static final int TAG_ACCOUNT_INFO = 000000;
	...
	public static final String TRF_FILES = "TRF_FILES";
	...
	public static final String D_RECORD_TYPE_CODE = "D_RECORD_TYPE_CODE";
	public static final String D_TXN_SERIAL_NUMBER = "D_TXN_SERIAL_NUMBER";
	public static final String D_DEBIT_CREDIT = "D_DEBIT_CREDIT";
	public static final String D_POSTED_FARE = "D_POSTED_FARE";
	public static final String D_VIOLATION_FEE = "D_VIOLATION_FEE";
	public static final String D_REVENUE_AGENCY_CODE = "D_REVENUE_AGENCY_CODE";
	public static final String D_RECON_CODE = "D_RECON_CODE";
	public static final String D_RECON_SUB_CODE = "D_RECON_SUB_CODE";
	public static final String D_REVENUE_DATE = "D_REVENUE_DATE";
	public static final String D_POSTED_DATE = "D_POSTED_DATE";
	public static final String D_TRX_SERIAL_NO = "D_TRX_SERIAL_NO";
	
	public static final String D_PLATE_COUNTRY = "D_PLATE_COUNTRY";
	public static final String D_PLATE_STATE = "D_PLATE_STATE";
	public static final String D_PLATE_TYPE = "D_PLATE_TYPE";
	public static final String D_PLATE_NUMBER = "D_PLATE_NUMBER";
	
	public static final String T_RECORD_TYPE_CODE = "T_RECORD_TYPE_CODE";

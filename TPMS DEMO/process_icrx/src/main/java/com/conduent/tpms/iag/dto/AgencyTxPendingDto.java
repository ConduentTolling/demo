...
public class AgencyTxPendingDto {
	...
	private AccountTollPostDTO tollPostDTO;
	private TollPostResponseDTO tollPostResponseDTO;
	...
	public AccountTollPostDTO getTollPostDTO() {
		return tollPostDTO;
	}
	public void setTollPostDTO(AccountTollPostDTO tollPostDTO) {
		this.tollPostDTO = tollPostDTO;
	}
	public TollPostResponseDTO getTollPostResponseDTO() {
		return tollPostResponseDTO;
	}
	public void setTollPostResponseDTO(TollPostResponseDTO tollPostResponseDTO) {
		this.tollPostResponseDTO = tollPostResponseDTO;
	}
	@Override
	public String toString() {
		return "AgencyTxPendingDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txSeqNumber="
				...
				+ ", txStatus=" + txStatus + ", duplSerialNum=" + duplSerialNum + ", tollPostDTO=" + tollPostDTO
				+ ", tollPostResponseDTO=" + tollPostResponseDTO + "]";
	}

...
@Service
public class ICRXService {
	
		
		@Autowired
		protected IcrxFileParserImpl IcrxFileParserImpl;
		
		private static final Logger logger = LoggerFactory.getLogger(ICRXService.class);
		...
		public void processFiles(File file) throws IOException, InterruptedException
		{
			...
			IcrxFileParserImpl.loadConfigurationMapping(fileType);

...
public class TranDetail 
{
	...
	public String toString() {
		return "TranDetail [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txType=" + txType
				...
				+ postedFareAmount + ", etcFareAmount=" + etcFareAmount + ", transactionInfo=" + transactionInfo
				+ ", planCharged=" + planCharged + ", txStatus=" + txStatus + ", postedDate=" + postedDate
				+ ", depositId=" + depositId + ", frontOcrPlateCountry=" + frontOcrPlateCountry

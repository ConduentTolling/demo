 ...
 * <p>
 * UploadManager can be configured to control how/when it does multi-part
 * uploads, and manages the underlying upload method. Clients construct a
 * PutObjectRequest similar to what they normally would.
 */
public class OracleObjectStorage {

 ...
 *
 */
public class ItguConstants {

	public static final String MTA_AGENCY_ID = "2";
	public static final String ITAG_FILE_EXTENSION = ".ITAG";
	public static final String MTA_FILE_PREFIX = "0008";// Should be define in the DB. As tenant level configuration.
	public static final String HOME_AGENCY_ID = MTA_AGENCY_ID;
	...
	public static final String TAG_AGENCY_ID = "TAG_AGENCY_ID";
	public static final String TAG_SERIAL_NUMBER = "TAG_SERIAL_NUMBER";
	public static final String TAG_STATUS = "TAG_STATUS";
	public static final String TAG_ACCT_INFO="TAG_ACCT_INFO";
	public static final String TAG_HOME_AGENCY="TAG_HOME_AGENCY";
	public static final String TAG_AC_TYPE_IND="TAG_AC_TYPE_IND";
	public static final String TAG_ACCOUNT_NO="TAG_ACCOUNT_NO";
	public static final String TAG_PROTOCOL="TAG_PROTOCOL";
	public static final String TAG_TYPE="TAG_TYPE";
	public static final String TAG_MOUNT="TAG_MOUNT";

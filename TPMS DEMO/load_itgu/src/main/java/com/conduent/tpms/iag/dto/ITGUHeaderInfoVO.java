 ...
 *
 */
public class ITGUHeaderInfoVO extends BaseVO implements Serializable {
	...
	private LocalDateTime prevfiledatetime;
	...
	public void setCountstat4(String countstat4) {
	  ...
	  public String getVersion() {
		...
		public LocalDateTime getPrevfiledatetime() {
			return prevfiledatetime;
		}

		public void setPrevfiledatetime(LocalDateTime prevfiledatetime) {
			this.prevfiledatetime = prevfiledatetime;
		}

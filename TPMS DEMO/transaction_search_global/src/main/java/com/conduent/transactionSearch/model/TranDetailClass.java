...
public class TranDetailClass 
{
	...
	private int txStatus; //TX_STATUS                        NUMBER(5)                   
	private Timestamp entryTxTimestamp; //ENTRY_TX_TIMESTAMP               TIMESTAMP(3) WITH TIME ZONE 
	private Timestamp txTimestamp; //TX_TIMESTAMP                     TIMESTAMP(3) WITH TIME ZONE 
	...
	public String toString() {
		return "TranDetailClass [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txType=" + txType
				...
				+ ", isLprEnabled=" + isLprEnabled + ", fullFareAmount=" + fullFareAmount + ", discountedAmount="
				...
				+ planType + ", reserved=" + reserved + ", atpFileId=" + atpFileId + ", avcClass=" + avcClass
				+ ", tagIagClass=" + tagIagClass + ", tagClass=" + tagClass + ", aetFlag=" + aetFlag + ", txStatus="
				+ txStatus + ", entryTxTimestamp=" + entryTxTimestamp + ", txTimestamp=" + txTimestamp + ", postedDate="
				+ postedDate + ", frontOcrPlateCountry=" + frontOcrPlateCountry + ", frontOcrPlateState="
				+ frontOcrPlateState + ", frontOcrPlateType=" + frontOcrPlateType + ", frontOcrPlateNumber="
				+ frontOcrPlateNumber + ", frontOcrConfidence=" + frontOcrConfidence + ", frontOcrImageIndex="
				+ frontOcrImageIndex + ", frontImageColor=" + frontImageColor + ", rearOcrPlateCountry="
				+ rearOcrPlateCountry + ", rearOcrPlateState=" + rearOcrPlateState + ", rearOcrPlateType="
				+ rearOcrPlateType + ", rearOcrPlateNumber=" + rearOcrPlateNumber + ", rearOcrConfidence="
				+ rearOcrConfidence + ", rearOcrImageIndex=" + rearOcrImageIndex + ", rearImageColor=" + rearImageColor
				+ "]";
	}

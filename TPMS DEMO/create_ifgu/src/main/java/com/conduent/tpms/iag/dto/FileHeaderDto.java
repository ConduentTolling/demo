...
public class FileHeaderDto {
	...
	String delimiter;
	String fileDateTime;
	String prevfileDateTime;
	
	
	
	public String getPrevfileDateTime() {
		return prevfileDateTime;
	}
	public void setPrevfileDateTime(String prevfileDateTime) {
	...
	public String toString() {
		return "FileHeaderDto [fileType=" + fileType + ", fromAgencyId=" + fromAgencyId + ", fileDate=" + fileDate
				...
				+ ", delimiter=" + delimiter + ", fileDateTime=" + fileDateTime + ", prevfileDateTime="
				+ prevfileDateTime + "]";
	}

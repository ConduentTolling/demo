...
public class Constants {
	...
	//IFGU filename params
	public static final String IFGU = "IFGU";
	...
	public static final String T_INCR_TAG_STATUS_ALLSORTED = "T_INCR_TAG_STATUS_ALLSORTED";
	...
	//FTAG Increment properties
	public static final int IFGU_REC_LENGTH = 18;
	public static final int IFGU_FILE_DATE_END = 18;
	public static final int IFGU_FILE_DATE_START = 4;
	
	public static final String FILE_GEN_TYPE_FULL = "FULL";
    public static final String FILE_GEN_TYPE_INCR = "INCREMENT";
	
	public static final String FTAG_FILES = "FTAG_FILES";
	public static final String FTAG_STAT_FILES = "FTAG_STAT_FILES";
	
	public static final String IFGU_FILES = "IFGU_FILES";
	public static final String IFGU_STAT_FILES = "IFGU_STAT_FILES";

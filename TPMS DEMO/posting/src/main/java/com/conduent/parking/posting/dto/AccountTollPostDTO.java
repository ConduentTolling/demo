...
public class AccountTollPostDTO {
	...
	public void setTxStatus(String accountFinStatus,Integer payType)
	{
		if (txTypeInd.equals("P")) //Z
		{
			this.setTxStatus(TxStatus.TX_STATUS_PSNT.getCode());
		}
		else if (txTypeInd.equals("C")) //Z
		{
			this.setTxStatus(TxStatus.TX_STATUS_PSNT.getCode());
		}
		else if (txTypeInd.equals("R")) //rej
		{
			this.setTxStatus(TxStatus.TX_STATUS_PSNT.getCode());
		}
	...
	public static void init(ParkingTransaction etc,AccountTollPostDTO toll)
	{
		try
		{

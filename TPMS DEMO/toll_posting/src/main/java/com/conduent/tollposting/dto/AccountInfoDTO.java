...
import com.conduent.tollposting.constant.AccountStatus;
...
public class AccountInfoDTO 
{
	...
	public static TxStatus checkInvalidTxStatus(AccountInfoDTO accountInfo)
	{
		...
		else if(accountInfo.getAcctAccountStatus().intValue()==AccountStatus.CLOSE_PEND.getCode())
		{
			return TxStatus.TX_STATUS_INVACCLSP;
		}
		else if(accountInfo.getAcctAccountStatus().intValue()==AccountStatus.ACTIVE.getCode() || accountInfo.getAcctAccountStatus().intValue()==AccountStatus.RVKW.getCode()) {
			return null;
		}
		else
		{

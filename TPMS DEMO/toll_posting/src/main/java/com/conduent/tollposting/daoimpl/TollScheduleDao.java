...
public class TollScheduleDao implements ITollScheduleDao
{
	...
	public List<TollSchedule> getTollSchedule(LocalDate txDate, Integer plazaId,Integer entryPlazaId, Integer vehicleClass)
	{
		...
		if(list==null || list.isEmpty()) {
			paramSource.addValue(Constants.ENTRY_PLAZA_ID, entryPlazaId==0||entryPlazaId==null?plazaId:entryPlazaId);
			list= namedJdbcTemplate.query(queryToCheckFile,paramSource, new BeanPropertyRowMapper<TollSchedule>(TollSchedule.class));
		}

...
public class TripHistory 
{
	...
	private Double tripCharged=0.0;
	private String apdId;
	private Integer lateTrips;
	private Long etcAccountId;
	private Integer planTypeId;
	private Long lastLaneTxId;
	private LocalDateTime lastTxPostTimestamp;			//changed to Localdate due to EST timestamp
	...
	public void setLastTxPostTimestamp(LocalDateTime localDateTime) {
		this.lastTxPostTimestamp = localDateTime;
	}
	...
	public String toString() {
		return "TripHistory [tripStartDate=" + tripStartDate + ", tripEndDate=" + tripEndDate + ", recongDate="
				...
				+ ", planTypeId=" + planTypeId + ", lastLaneTxId=" + lastLaneTxId + ", lastTxPostTimestamp="
				+ lastTxPostTimestamp + "]";
	}

...
public class TPMSGateway<T> {
	...
	public T getMaxTollAmount() {
		return maxTollAmount;
	}

	public void setMaxTollAmount(T maxTollAmount) {
		this.maxTollAmount = maxTollAmount;
	}

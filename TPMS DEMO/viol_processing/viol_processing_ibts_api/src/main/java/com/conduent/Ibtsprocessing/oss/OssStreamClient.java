package com.conduent.Ibtsprocessing.oss;
...
import com.conduent.Ibtsprocessing.utility.Util;
...
public class OssStreamClient {
	...
	public List<String> getMessage(int limit) throws IOException
	{
		try
		{
			if(streamClient==null)
			...
			logger.info("getMessagesResponse: "+getMessagesResponse);
			if(getMessagesResponse!=null && getMessagesResponse.getItems()!=null && !getMessagesResponse.getItems().isEmpty()) 
			{
				logger.info("Message is: "+getMessagesResponse.getItems().size());

...
public class EntryTransactionDto implements Serializable {
	...
	public String toString() {
		return "EntryTransactionDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txSeqNumber="

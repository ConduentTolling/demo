...
public class ExitTransactionDto implements Serializable {
	...
	private String bufferedRreadFlag;
	...
	public String getBufferedRreadFlag() {
		return bufferedRreadFlag;
	}
	public void setBufferedRreadFlag(String bufferedRreadFlag) {
		this.bufferedRreadFlag = bufferedRreadFlag;
	}
	...
	public String toString() {
		return "ExitTransactionDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txSeqNumber="
				+ txSeqNumber + ", externFileId=" + externFileId + ", laneId=" + laneId + ", txTimestamp=" + txTimestamp
				...
				+ ", bufferedRreadFlag=" + bufferedRreadFlag + ", laneDeviceStatus=" + laneDeviceStatus
				...
				+ reconSubCodeInd + ", externFileDate=" + externFileDate + ", mileage=" + mileage + ", txDate=" + txDate
				...
				+ ", depositId=" + depositId + ", etcFareAmount=" + etcFareAmount + ", postedFareAmount="
				+ postedFareAmount + ", expectedRevenueAmount=" + expectedRevenueAmount + ", videoFareAmount="
				+ videoFareAmount + ", cashFareAmount=" + cashFareAmount + "]";
	}

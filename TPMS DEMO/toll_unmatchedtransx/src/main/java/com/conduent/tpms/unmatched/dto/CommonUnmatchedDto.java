 ...
 *
 */
public class CommonUnmatchedDto {
...
//	private Integer etcTxStatus;
	...
	public String toString() {
		return "CommonUnmatchedDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txSeqNumber="
				...
				+ ", discountedAmount2=" + discountedAmount2 + ", fareType=" + fareType + "]";
	}

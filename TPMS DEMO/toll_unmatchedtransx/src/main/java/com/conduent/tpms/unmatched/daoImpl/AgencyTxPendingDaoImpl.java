...
public class AgencyTxPendingDaoImpl implements AgencyTxPendingDao {
	...
	@Override
	public void insert(CommonUnmatchedDto commonDTO) {
		logger.info("Insert into Agency Tx Pending table starts for lane tx id {}", commonDTO.getLaneTxId());

		String query = LoadJpaQueries.getQueryById(UnmatchedConstant.INSERT_INTO_T_AGENCY_TX_PENDING);
	...
	private void setSourceSystem(CommonUnmatchedDto commonDTO, PreparedStatement ps) throws SQLException {
...
//	private void setEtcTxStatus(CommonUnmatchedDto commonDTO, final PreparedStatement ps) throws SQLException {

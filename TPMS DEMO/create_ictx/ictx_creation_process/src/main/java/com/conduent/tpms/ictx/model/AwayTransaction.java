...
//extends AwayTransactionCorrection{
	...
	public String toString() {
		return "AwayTransaction [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txSeqNumber="
				...
				+ ", txType=" + txType + ", txSubType=" + txSubType + ", tillSystemType=" + tillSystemType
				...
				+ ", reciprocityTrx=" + reciprocityTrx + ", videoFareAmount=" + videoFareAmount + ", etcFareAmount="
				+ etcFareAmount + ", cashFareAmount=" + cashFareAmount + ", expectedRevenueAmount="
				+ expectedRevenueAmount + ", postedFareAmount=" + postedFareAmount + ", dstAtpFileId=" + dstAtpFileId
				+ "]";
	}
	...
	public LocalDateTime getEntryTimestampLocalDateTime() {
		return entryTimestamp.toLocalDateTime();
	}
	
	public LocalDateTime getTxTimestampLocalDateTime() {
		return txTimestamp.toLocalDateTime();
	}

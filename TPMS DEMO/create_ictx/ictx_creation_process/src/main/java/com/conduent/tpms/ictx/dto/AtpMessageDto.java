...
public class AtpMessageDto {
	...
	public Long getCorrectionReason() {
		return correctionReason;
	}
	
	public void setCorrectionReason(Long correctionReason) {
		this.correctionReason = correctionReason;
	}

	@Override
	public String toString() {
		return "AtpMessageDto [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo + ", txSeqNumber="
				...
				+ ", reciprocityTrx=" + reciprocityTrx + ", tollAmount=" + tollAmount + ", correctionReason="
				+ correctionReason + ", txStatus=" + txStatus + "]";
	}

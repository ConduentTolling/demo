...
public class DateUtils
{
	...
	public static Date parseDate(LocalDate fileDate, String pattern) {
	...
	public static String getDateYYYYMMDD(String mydate, String format) throws ParseException { 
	if (mydate != null && !(mydate.trim().isEmpty())) {
		SimpleDateFormat sdf= new SimpleDateFormat("yyyyMMdd");
		Date date = sdf.parse(mydate);
		SimpleDateFormat sdfNew = new SimpleDateFormat(format, Locale.ENGLISH);
		String firstDate = sdfNew.format(date);
		return firstDate;
		}
		return null;
		}
	
	public static String getDateTimeYYYYMMDD(String mydate, String format) throws ParseException { 
	if (mydate != null && !(mydate.trim().isEmpty())) {

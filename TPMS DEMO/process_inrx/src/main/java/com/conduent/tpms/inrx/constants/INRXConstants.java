 ...
 *
 */
public class INRXConstants {
    //public static final String NYSTA_AGENCY_ID = "016";
	public static final String NYSTA_AGENCY_ID = "008";
	public static final String INRX_FILE_EXTENSION = ".INRX";
	public static final String HOME_AGENCY_ID = NYSTA_AGENCY_ID;
	public static final String HOST_AGENCY_ID = "008";
	public static final String MTA_AGENCY_ID = "002";
	...
	public static final String F_HOME_AGENCY_ID = "F_HOME_AGENCY_ID";
	public static final String F_FILE_DATE_TIME = "F_FILE_DATE_TIME";
	public static final String F_DATE = "F_DATE";
	public static final String  F_UNDERSCORE = "F_UNDERSCORE";
	public static final String H_FILE_TYPE = "H_FILE_TYPE";
	public static final String H_HOME_AGENCY_ID = "H_HOME_AGENCY_ID";
	...
	public static final String H_HOST_AGENCY_ID ="H_HOST_AGENCY_ID";
	...
	public static final String F_HOST_AGENCY_ID = "F_HOST_AGENCY_ID";
	...
	public static final Integer STANDARD_PLAN = 1;
	public static final String POST = "POST";
	public static final String PSNT = "PSNT";
	public static final String PPST = "PPST";
	public static final String NPST = "NPST";
	
	
	
	// t_away_agency_tx table field
	...
	// Queue
	public static final Integer EVENT_TYPE = 38;
	public static final Integer AWPOSTVTOL = 727;
	public static final Integer AWPOSTITOL = 728;
	public static final Integer AWREJVTOL = 722;
	public static final Integer AWREJITOL = 723;
	
	// IRXC constant
	public static final String IRXN = "IRXN";
	public static final String H_ITXN_FILE_NUM = "H_ITXN_FILE_NUM";
}

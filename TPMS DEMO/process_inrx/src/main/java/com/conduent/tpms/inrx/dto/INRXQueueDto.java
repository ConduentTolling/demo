...
public class INRXQueueDto implements Serializable {
	...
	public static INRXQueueDto dtoFromJson(String message) {
		INRXQueueDto queueMessageDTO = null;
		Gson gson = new Gson();
		queueMessageDTO = gson.fromJson(message, INRXQueueDto.class);

...
@Service
public class INRXService {
	
		
		@Autowired
		protected InrxFileParserImpl InrxFileParserImpl;
		
		private static final Logger logger = LoggerFactory.getLogger(INRXService.class);
		...
		public void processFiles(File file) throws IOException, InterruptedException
		{
			...
			InrxFileParserImpl.loadConfigurationMapping(fileType);

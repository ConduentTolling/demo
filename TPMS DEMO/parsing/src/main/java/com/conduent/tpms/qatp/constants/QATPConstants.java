...
public class QATPConstants {
	...
	public static final String AGENCY_ID_FNTX = "51";
	public static final String NYSTA_DEVICE_PREFIX = "004";
	public static final String NYSTA_FROM_AGENCY = "CSC";
	public static final String HOME_AGENCY_ID = NYSTA_AGENCY_ID;// Should be define in the DB. As tenant level configuration.
	...
	//FO TRNX 
	public static final String FNTX = "FNTX";
	public static final String FO_AGENCY_ID = "002";

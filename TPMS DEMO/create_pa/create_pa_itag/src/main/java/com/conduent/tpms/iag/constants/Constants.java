...
public class Constants {
	...
	public final static String ITAG = "ITAG";
	...
	public static final String WORKING_DEST = "WORKING_DEST";
	//public static final String FROM_ENTITY = "CSC";
	public static final String FROM_ENTITY = "0000";
	public static final String To_ENTITY = "0005";
	public static final String ZIP = "ZIP";
	public static final String zip = "zip";
	public final static String ATGU = "ATGU";
	public static final String SRC_DEST = "SRC_DEST";
	...
	public static final String PA_FILES = "PA_FILES";

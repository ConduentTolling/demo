...
public class RequestObject 
{
	 ...
	 */
	@ApiModelProperty(value="Agency file Type",dataType ="String", required =true, example ="ATGU")
	@JsonProperty(required=true)
	String fileType;
	 ...
	 */
	@ApiModelProperty(value ="Agency file generation type", dataType ="String",required=true,example="INCR")
	@JsonProperty(required=true)
	String genType;

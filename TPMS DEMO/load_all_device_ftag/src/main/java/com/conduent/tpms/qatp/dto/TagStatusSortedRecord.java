...
public class TagStatusSortedRecord implements Serializable {
	...
	public Integer getRebillPayType() {
		return rebillPayType;
	}
	public void setRebillPayType(Integer rebillPayType) {
	...
	public int getFtagPlanInfo() {
		return ftagPlanInfo;
	}
	public void setFtagPlanInfo(int ftagPlanInfo) {
	...
	public String toString() {
		return "TagStatusSortedRecord [agencyId=" + agencyId + ", accountNo=" + accountNo + ", etcAccountId="
				...
				+ deviceNo + ", financialStatus=" + financialStatus + ", tagOwningAgency=" + tagOwningAgency
				+ ", thwyAcct=" + thwyAcct + ", currentBalance=" + currentBalance + ", rebillPayType=" + rebillPayType
				+ ", rebillAmount=" + rebillAmount + ", rebillThreshold=" + rebillThreshold + ", postPaidStatus="
				+ postPaidStatus + ", acctSuspFlag=" + acctSuspFlag + ", postPaidFlag=" + postPaidFlag
				+ ", firstTollDate=" + firstTollDate + ", retailTagStatus=" + retailTagStatus + ", speedAgency="
				+ speedAgency + ", allPlans=" + allPlans + ", revPlanCount=" + revPlanCount + ", postPaidPlanCnt="
				+ postPaidPlanCnt + ", nystaNonRevCount=" + nystaNonRevCount + ", nystaAnnualPlanCount="
				+ nystaAnnualPlanCount + ", nystaPostPaidComlCount=" + nystaPostPaidComlCount + ", nystaTagStatus="
				+ nystaTagStatus + ", nysbaNonRevCount=" + nysbaNonRevCount + ", mtaNonRevCount=" + mtaNonRevCount
				+ ", mtaSpecialPlanCount=" + mtaSpecialPlanCount + ", mtaTagStatus=" + mtaTagStatus + ", paNonRevCount="
				+ paNonRevCount + ", paBridgesCount=" + paBridgesCount + ", paSiBridgesCount=" + paSiBridgesCount
				+ ", paCarpoolCount=" + paCarpoolCount + ", rioNonRevCount=" + rioNonRevCount + ", plzLimitedCount="
				+ plzLimitedCount + ", paTagStatus=" + paTagStatus + ", rioTagStatus=" + rioTagStatus
				+ ", ftagTagStatus=" + ftagTagStatus + ", iagCodedClass=" + iagCodedClass + ", optInOutFlag="
				+ optInOutFlag + ", prevalidationFlag=" + prevalidationFlag + ", isCompanionTag=" + isCompanionTag
				+ ", itagInfo=" + itagInfo + ", itagTagStatus=" + itagTagStatus + ", fromPlaza=" + fromPlaza
				+ ", toPlaza=" + toPlaza + ", tsCtrlStr=" + tsCtrlStr + ", plansStr=" + plansStr + ", mtagPlanStr="
				+ mtagPlanStr + ", mtaCtrlStr=" + mtaCtrlStr + ", rioCtrlStr=" + rioCtrlStr + ", ftagPlanInfo="
				+ ftagPlanInfo + ", nysbaTagStatus=" + nysbaTagStatus + ", cscLookupKey=" + cscLookupKey + ", updateTs="
				+ updateTs + ", deviceStatus=" + deviceStatus + ", retailerStatus=" + retailerStatus
				+ ", isPrevalidated=" + isPrevalidated + ", primaryRebillPayType=" + primaryRebillPayType
				+ ", tbnrfpCount=" + tbnrfpCount + ", mtafCount=" + mtafCount + ", govtCount=" + govtCount
				+ ", sirCount=" + sirCount + ", rrCount=" + rrCount + ", brCount=" + brCount + ", qrCount=" + qrCount

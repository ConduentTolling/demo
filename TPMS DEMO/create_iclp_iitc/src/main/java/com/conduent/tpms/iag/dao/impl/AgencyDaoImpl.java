...
public class AgencyDaoImpl implements AgencyDao {
	...
	public List<Agency> getAgency() {
		String queryToCheckFile = LoadJpaQueries.getQueryById(ICLPConstants.LOAD_T_AGENCY);
	...
	public List<String> getHomeAgencyList() {
		String queryToCheckFile = LoadJpaQueries.getQueryById(ICLPConstants.SELECT_HOME_DEVICE_PREFIX);
	...
	public String getInvalidStatusFlag() {
		...
		return jdbcTemplate.queryForObject(queryToCheckFile, String.class);
	}

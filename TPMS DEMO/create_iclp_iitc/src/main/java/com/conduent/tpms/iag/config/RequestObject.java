...
public class RequestObject 
{
	 ...
	 * Home agency id
	 */
	@ApiModelProperty(value = "Agency Id", dataType = "Integer", required = true, example = "8")
	int agencyId;
	
	/**
	 * Required file format
	 */
	@ApiModelProperty(value = "Agency file type", dataType = "String", required = true, example = "ICLP/IITC")
	String fileType;

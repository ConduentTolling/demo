...
public class Constants {
	...
	//AGENCY ID
	public static final String HOME_AGENCY_ID = "0001";
	public static final String HOME_AGENCY_ID_FORPEBA="0008";
	...
	public static final int PEBA_AGENCY_ID = 19;
	public static final int TIBA_AGENCY_ID = 63;
	...
	public static final String FILE_TYPE_ITAG="ITAG";
	...
	public static final String F_TAG_HOME_AGENCY = "F_TAG_HOME_AGENCY";
	public static final String F_UNDER_SCORE = "F_UNDER_SCORE";
	...
	public static final String H_FROM_AGENCY = "H_FROM_AGENCY";
	public static final String ispeba="ispeba";
	...
	public static final String D_TAG_SERIAL_NO = "D_TAG_SERIAL_NO";
    public static final String TAG_FROM_DATABASE="TAG_FROM_DATABASE";
	...
	public static final String D_LOW_LIMIT_VAL = "008";
	public static final String D_HIGH_LIMIT_VAL = "OO9";

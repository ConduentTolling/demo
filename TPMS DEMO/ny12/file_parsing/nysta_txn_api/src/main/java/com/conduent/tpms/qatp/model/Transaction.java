	...
	public TranDetail getTranDetail(TimeZoneConv timeZoneConv)
	{
		...
		if(entryTimeStamp!=null)
		{
			if(DateUtils.parseLocalDate(entryTimeStamp.substring(0, 8),"yyyyMMdd") != null) {
				//obj.setEntryTxTimeStamp(DateUtils.getTimeStamp(entryTimeStamp, "yyyyMMddHHmmssSS").toLocalDateTime());
				//LocalDateTime temp = DateUtils.getTimeStamp(entryTimeStamp, "yyyyMMddHHmmssSS").toLocalDateTime();
				
				LocalDateTime txTimeStamp=LocalDateTime.parse(entryTimeStamp,DateTimeFormatter.ofPattern("yyyyMMddHHmmssSS"));
				
				System.out.println("TxTime Stamp LocalDate..........."+txTimeStamp);
				if(exitPlaza != null) {
					//obj.setEntryTxTimeStamp(timeZoneConv.zonedTxTime(temp,  Long.valueOf(exitPlaza)));
					obj.setEntryTxTimeStamp(timeZoneConv.zonedTxTimeOffset(txTimeStamp,  Long.valueOf(exitPlaza)));
					System.out.println("TxTime Stamp LocalDate..........."+obj.getEntryTxTimeStamp());
				}

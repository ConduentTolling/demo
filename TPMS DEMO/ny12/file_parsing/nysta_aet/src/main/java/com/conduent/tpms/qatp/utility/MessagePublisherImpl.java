...
public class MessagePublisherImpl implements MessagePublisher {
	 ...
	 * @throws Exception 
	 */
	public long publishMessages(List<PutMessagesDetailsEntry> messages) throws Exception {
		long msgCounter = 0;
		...
		logger.debug("Publish message {} - Completed in {} ms",messages.size() ,ChronoUnit.MILLIS.between(from, to));
	...
	public void doThrottleCall() throws Exception {
		

		if(configVariable.getThrottleFlag().equals(Constants.TRUE))
		{
			Thread.sleep(configVariable.getThrottleTime());
		}

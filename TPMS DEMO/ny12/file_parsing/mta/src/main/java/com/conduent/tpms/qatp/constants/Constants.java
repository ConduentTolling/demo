...
public class Constants {
	...
	public static final long BATCH_RECORD_COUNT=10;
	...
	/*	public static final String LANE_TX_ID                = "LANE_TX_ID";
		...
		public static final String TRX_SUBTYPE               = "TRX_SUBTYPE";
		...
		public static final String ENTRY_LANE_SN             = "ENTRY_LANE_SN";
		...
		public static final String DEVICE_AGENCY_ID          = "DEVICE_AGENCY_ID";
		...
		public static final String ETC_VALIDATION            = "ETC_VALIDATION";
		...
		public static final String TRX_LANE_ID               = "TRX_LANE_ID";
		public static final String TRX_LANE_SN               = "TRX_LANE_SN";
		...
		public static final String FULL_FARE_AMT             = "FULL_FARE_AMT";
		public static final String EXT_HOST_REF_NUM          = "EXT_HOST_REF_NUM";
		public static final String EXT_FILE_ID               = "EXT_FILE_ID";
		public static final String RECEIVED_DATE             = "RECEIVED_DATE";
		public static final String ENTRY_PLAZA               = "ENTRY_PLAZA";
		public static final String EXIT_PLAZA                = "EXIT_PLAZA";
		...
		public static final String FRONT_OCR_PLATE_COUNTRY   = "FRONT_OCR_PLATE_COUNTRY";
		public static final String FRONT_OCR_PLATE_STATE     = "FRONT_OCR_PLATE_STATE";
		public static final String FRONT_OCR_PLATE_TYPE      = "FRONT_OCR_PLATE_TYPE";
		public static final String FRONT_OCR_PLATE_NUMBER    = "FRONT_OCR_PLATE_NUMBER";
		public static final String FRONT_OCR_CONFIDENCE      = "FRONT_OCR_CONFIDENCE";
		public static final String FRONT_OCR_IMAGE_INDEX     = "FRONT_OCR_IMAGE_INDEX";
		public static final String FRONT_IMAGE_COLOR         = "FRONT_IMAGE_COLOR";
		public static final String REAR_OCR_PLATE_COUNTRY    = "REAR_OCR_PLATE_COUNTRY";
		public static final String REAR_OCR_PLATE_STATE      = "REAR_OCR_PLATE_STATE";
		public static final String REAR_OCR_PLATE_TYPE       = "REAR_OCR_PLATE_TYPE";
		public static final String REAR_OCR_PLATE_NUMBER     = "REAR_OCR_PLATE_NUMBER";
		public static final String REAR_OCR_CONFIDENCE       = "REAR_OCR_CONFIDENCE";
		public static final String REAR_OCR_IMAGE_INDEX      = "REAR_OCR_IMAGE_INDEX";
		public static final String REAR_IMAGE_COLOR          = "REAR_IMAGE_COLOR";  */

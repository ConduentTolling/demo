...
public class QATPConstants {
	...
	public static final String MTA_DEVICE_PREFIX = "008";
	...
	public static final String AGENCY_NAME = "MTA B&T.TEST";														// configuration.
	...
	public static final String LANEHEADER = "LANEHEADER";

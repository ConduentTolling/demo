...
import com.conduent.tpms.qatp.dao.InsertMTADao;
import com.conduent.tpms.qatp.model.QatpStatistics;
import com.conduent.tpms.qatp.model.XferControl;

@Repository
public class InsertMTADaoImpl implements InsertMTADao {

	private static final Logger logger = LoggerFactory.getLogger(InsertMTADaoImpl.class);

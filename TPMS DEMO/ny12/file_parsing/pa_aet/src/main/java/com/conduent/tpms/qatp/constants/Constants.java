...
public class Constants {
	...
	/*
	 * public static final String LANE_TX_ID = "LANE_TX_ID"; public static final
	 * String TRX_TYPE = "TRX_TYPE"; public static final String TRX_SUBTYPE =
	 * "TRX_SUBTYPE"; public static final String TOLL_SYSTEM_TYPE =
	 * "TOLL_SYSTEM_TYPE"; public static final String TOLL_REVENUE_TYPE =
	 * "TOLL_REVENUE_TYPE"; public static final String ACCOUNT_TYPE =
	 * "ACCOUNT_TYPE"; public static final String ENTRY_DATE = "ENTRY_DATE"; public
	 * static final String ENTRY_TIME = "ENTRY_TIME"; public static final String
	 * ENTRY_LANE_ID = "ENTRY_LANE_ID"; public static final String ENTRY_LANE_SN =
	 * "ENTRY_LANE_SN"; public static final String ENTRY_DATA_SOURCE =
	 * "ENTRY_DATA_SOURCE"; public static final String ENTRY_VEHICLE_SPEED =
	 * "ENTRY_VEHICLE_SPEED"; public static final String DEVICE_AGENCY_ID =
	 * "DEVICE_AGENCY_ID"; public static final String DEVICE_NUMBER =
	 * "DEVICE_NUMBER"; public static final String LANE_TYPE = "LANE_TYPE"; public
	 * static final String LANE_MODE = "LANE_MODE"; public static final String
	 * LANE_STATE = "LANE_STATE"; public static final String COLLECTOR_NUMBER =
	 * "COLLECTOR_NUMBER"; public static final String ACTUAL_CLASS = "ACTUAL_CLASS";
	 * public static final String ACTUAL_AXLES = "ACTUAL_AXLES"; public static final
	 * String EXTRA_AXLES = "EXTRA_AXLES"; public static final String TAG_CLASS =
	 * "TAG_CLASS"; public static final String TAG_AXLES = "TAG_AXLES"; public
	 * static final String TAG_IAG_CLASS = "TAG_IAG_CLASS"; public static final
	 * String AVC_CLASS = "AVC_CLASS"; public static final String AVC_AXLES =
	 * "AVC_AXLES"; public static final String ETC_VALIDATION = "ETC_VALIDATION";
	 * public static final String READ_PERF = "READ_PERF"; public static final
	 * String WRITE_PERF = "WRITE_PERF"; public static final String PROG_STAT =
	 * "PROG_STAT"; public static final String IMAGE_CAPTURED = "IMAGE_CAPTURED";
	 * public static final String VEHICLE_SPEED = "VEHICLE_SPEED"; public static
	 * final String SPEED_VIOLATION = "SPEED_VIOLATION"; public static final String
	 * RECIPROCITY_TRX = "RECIPROCITY_TRX"; public static final String TRX_DATE =
	 * "TRX_DATE"; public static final String TRX_TIME = "TRX_TIME"; public static
	 * final String TRX_LANE_ID = "TRX_LANE_ID"; public static final String
	 * TRX_LANE_SN = "TRX_LANE_SN"; public static final String BUF_READ =
	 * "BUF_READ"; public static final String ETC_ACCOUNT_ID = "ETC_ACCOUNT_ID";
	 * public static final String ETC_SUBACCOUNT = "ETC_SUBACCOUNT"; public static
	 * final String DEBIT_CREDIT = "DEBIT_CREDIT"; public static final String
	 * TOLL_AMOUNT = "TOLL_AMOUNT"; public static final String LICENSE_PLATE =
	 * "LICENSE_PLATE"; public static final String LICENSE_STATE = "LICENSE_STATE";
	 * public static final String LANE_HEALTH = "LANE_HEALTH"; public static final
	 * String READER_ID = "READER_ID"; public static final String IS_PEAK =
	 * "IS_PEAK"; public static final String FARE_TYPE = "FARE_TYPE"; public static
	 * final String FULL_FARE_AMT = "FULL_FARE_AMT"; public static final String
	 * EXT_HOST_REF_NUM = "EXT_HOST_REF_NUM"; public static final String EXT_FILE_ID
	 * = "EXT_FILE_ID"; public static final String RECEIVED_DATE = "RECEIVED_DATE";
	 * public static final String ENTRY_PLAZA = "ENTRY_PLAZA"; public static final
	 * String EXIT_PLAZA = "EXIT_PLAZA"; public static final String CORRECTION =
	 * "CORRECTION"; public static final String TOUR_SEGMENT_ID = "TOUR_SEGMENT_ID";
	 * public static final String DST_FLAG = "DST_FLAG"; public static final String
	 * LANE_DATA_SOURCE = "LANE_DATA_SOURCE"; public static final String
	 * PLAZA_AGENCY_ID = "PLAZA_AGENCY_ID"; public static final String
	 * ACCT_AGENCY_ID = "ACCT_AGENCY_ID"; public static final String RESERVED =
	 * "RESERVED"; public static final String IS_VIOLATION = "IS_VIOLATION"; public
	 * static final String IS_LPR_ENABLED = "IS_LPR_ENABLED"; public static final
	 * String FRONT_OCR_PLATE_COUNTRY = "FRONT_OCR_PLATE_COUNTRY"; public static
	 * final String FRONT_OCR_PLATE_STATE = "FRONT_OCR_PLATE_STATE"; public static
	 * final String FRONT_OCR_PLATE_TYPE = "FRONT_OCR_PLATE_TYPE"; public static
	 * final String FRONT_OCR_PLATE_NUMBER = "FRONT_OCR_PLATE_NUMBER"; public static
	 * final String FRONT_OCR_CONFIDENCE = "FRONT_OCR_CONFIDENCE"; public static
	 * final String FRONT_OCR_IMAGE_INDEX = "FRONT_OCR_IMAGE_INDEX"; public static
	 * final String FRONT_IMAGE_COLOR = "FRONT_IMAGE_COLOR"; public static final
	 * String REAR_OCR_PLATE_COUNTRY = "REAR_OCR_PLATE_COUNTRY"; public static final
	 * String REAR_OCR_PLATE_STATE = "REAR_OCR_PLATE_STATE"; public static final
	 * String REAR_OCR_PLATE_TYPE = "REAR_OCR_PLATE_TYPE"; public static final
	 * String REAR_OCR_PLATE_NUMBER = "REAR_OCR_PLATE_NUMBER"; public static final
	 * String REAR_OCR_CONFIDENCE = "REAR_OCR_CONFIDENCE"; public static final
	 * String REAR_OCR_IMAGE_INDEX = "REAR_OCR_IMAGE_INDEX"; public static final
	 * String REAR_IMAGE_COLOR = "REAR_IMAGE_COLOR";
	 */

...
@ApiModel(description = "All Attributes of T_UNMATCHED_ENTRY_TX")
public class TUnmatchedEntryTxRequestModel {

	@NotNull(message = "LaneTxId should not be NULL")
	...
	// @JsonSerialize(using = OffsetDateTimeConverter.class)
	...
	//@Digits(integer = 5, fraction = 0, message = "Length of EntryVehicleSpeed should not exceed 5")
	...
	//@Size(min = 1, max = 4, message = "PlateCountry Max length is 4")
	private String plateCountry;
	//@Size(min = 1, max = 2, message = "PlateState Max length is 2")
	...
	//@Size(min = 1, max = 1, message = "IsReversed Max length is 1")
	...
	//@Range(min = 0, max = 999, message = "Length of Mileage should not exceed 3")
	private Integer mileage;
	@JsonFormat(pattern = "yyyy-MM-dd")
	private LocalDate txDate;
	//@Range(min = 0, max = 999, message = "Length of DeviceReadCount should not exceed 3")
	private Integer deviceReadCount;
	//@Range(min = 0, max = 999, message = "Length of DeviceWriteCount should not exceed 3")
	private Integer deviceWriteCount;
	//@Range(min = 0, max = 999, message = "Length of EntryDeviceReadCount should not exceed 3")
	private Integer entryDeviceReadCount;
	//@Range(min = 0, max = 999, message = "Length of EntryDeviceWriteCount should not exceed 3")
	...
	//newly updated properties here
	private Integer eventType;
	private String outputFileType;
	private LocalDateTime eventTimeStamp;
	private Integer imageBatchID;
	private Integer imageBatchSeqNumber;
	...
	private Integer trailerPlate;
	private Date imageReviewTimeStamp;
	private Integer frontImgRejReason;
	...
	public Integer getImageBatchID() {
		return imageBatchID;
	}

	public void setImageBatchID(Integer imageBatchID) {
		this.imageBatchID = imageBatchID;
	}

	public Integer getImageBatchSeqNumber() {
		return imageBatchSeqNumber;
	}

	public void setImageBatchSeqNumber(Integer imageBatchSeqNumber) {
	...
	public Integer getTrailerPlate() {
		return trailerPlate;
	}

	public void setTrailerPlate(Integer trailerPlate) {
		this.trailerPlate = trailerPlate;
	}

	public Date getImageReviewTimeStamp() {
		return imageReviewTimeStamp;
	}

	public void setImageReviewTimeStamp(Date imageReviewTimeStamp) {
		this.imageReviewTimeStamp = imageReviewTimeStamp;
	}

	public Integer getFrontImgRejReason() {
		return frontImgRejReason;
	}

	public void setFrontImgRejReason(Integer frontImgRejReason) {
	...
	public String toString() {
		return "TUnmatchedEntryTxRequestModel [laneTxId=" + laneTxId + ", txExternRefNo=" + txExternRefNo
				+ ", txSeqNumber=" + txSeqNumber + ", externFileId=" + externFileId + ", laneId=" + laneId
				+ ", txTimeStamp=" + txTimeStamp + ", txModSeq=" + txModSeq + ", txTypeInd=" + txTypeInd
				+ ", txSubtypeInd=" + txSubtypeInd + ", tollSystemType=" + tollSystemType + ", laneMode=" + laneMode
				+ ", laneType=" + laneType + ", laneState=" + laneState + ", laneHealth=" + laneHealth
				+ ", plazaAgencyId=" + plazaAgencyId + ", plazaId=" + plazaId + ", collectorId=" + collectorId
				...
				+ forwardAxles + ", reverseAxles=" + reverseAxles + ", matchedTxExternRefNo=" + matchedTxExternRefNo
				...
				+ ", deviceProgramStatus=" + deviceProgramStatus + ", bufferedReadFlag=" + bufferedReadFlag
				...
				+ ", postedDate=" + postedDate + ", atpFileId=" + atpFileId + ", updateTs=" + updateTs + ", isReversed="
				...
				+ ", mileage=" + mileage + ", txDate=" + txDate + ", deviceReadCount=" + deviceReadCount
				+ ", deviceWriteCount=" + deviceWriteCount + ", entryDeviceReadCount=" + entryDeviceReadCount
				+ ", entryDeviceWriteCount=" + entryDeviceWriteCount + ", depositId=" + depositId + ", etcFareAmount="
				...
				+ ", eventType=" + eventType + ", outputFileType=" + outputFileType + ", eventTimeStamp="
				+ eventTimeStamp + ", imageBatchID=" + imageBatchID + ", imageBatchSeqNumber=" + imageBatchSeqNumber
				+ ", outputFileID=" + outputFileID + ", imageIndex=" + imageIndex + ", imgFileIndex=" + imgFileIndex
				+ ", imageRvwClerkID=" + imageRvwClerkID + ", reviewedVehicleType=" + reviewedVehicleType
				+ ", reviewedDate=" + reviewedDate + ", dmvPlateType=" + dmvPlateType + ", taxi=" + taxi
				+ ", limousine=" + limousine + ", trailerPlate=" + trailerPlate + ", imageReviewTimeStamp="
				+ imageReviewTimeStamp + ", frontImgRejReason=" + frontImgRejReason + ", reviewedClass=" + reviewedClass
				+ "]";
	}

...
public class AckFileInfoDto implements Serializable {
	...
	public void setAckFileDate(LocalDate ackFileDate) {
	  ...
	  public String getAckFileTime() { return ackFileTime; }
	  
	  public void setAckFileTime(String ackFileTime) { this.ackFileTime =
	  ackFileTime; }
	...
	/*
	 * public LocalDateTime getAckFileTime() { return ackFileTime; }
	 * 
	 * public void setAckFileTime(LocalDateTime ackFileTime) { this.ackFileTime =
	 * ackFileTime; }
	 */

...
public class TagStatusSortedRecord implements Serializable {
	...
	public String toString() {
		return "TagStatusSortedRecord [agencyId=" + agencyId + ", accountNo=" + accountNo + ", etcAccountId="
				+ etcAccountId + ", accountType=" + accountType + ", accountTypeCd=" + accountTypeCd
				+ ", accountStatus=" + accountStatus + ", deviceNo=" + deviceNo + ", financialStatus=" + financialStatus
				...
				+ tagClass + ", deviceStatus=" + deviceStatus + ", retailerStatus=" + retailerStatus
